...
class _$NotificationStateTearOff {
  ...
  Data<T> data<T>({List<NotificationModel> data = const []}) {
    return Data<T>(
      data: data,
    );
  }
...
mixin _$NotificationState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<NotificationModel> data) data,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<NotificationModel> data)? data,
...
abstract class $NotificationStateCopyWith<T, $Res> {
  factory $NotificationStateCopyWith(NotificationState<T> value,
      ...
      _$NotificationStateCopyWithImpl<T, $Res>;
}
...
class _$NotificationStateCopyWithImpl<T, $Res>
  ...
  final NotificationState<T> _value;
  // ignore: unused_field
  final $Res Function(NotificationState<T>) _then;
}
...
class _$Idle<T> implements Idle<T> {
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.idle()';
  }
...
abstract class Idle<T> implements NotificationState<T> {
...
class _$Data<T> implements Data<T> {
  ...
  @override
  String toString() {
    return 'NotificationState<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements NotificationState<T> {
  const factory Data({List<NotificationModel> data}) = _$Data<T>;
