...
class _$CalendarStateTearOff {
  ...
  Data<T> data<T>({required Map<DateTime, List<Calendar>> data}) {
    return Data<T>(
      data: data,
    );
  }
...
/// @nodoc
mixin _$CalendarState<T> {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function() idle,
    required TResult Function() loading,
    required TResult Function(String error) error,
    required TResult Function(Map<DateTime, List<Calendar>> data) data,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(Map<DateTime, List<Calendar>> data)? data,
...
/// @nodoc
abstract class $CalendarStateCopyWith<T, $Res> {
  factory $CalendarStateCopyWith(
          CalendarState<T> value, $Res Function(CalendarState<T>) then) =
      _$CalendarStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$CalendarStateCopyWithImpl<T, $Res>
    implements $CalendarStateCopyWith<T, $Res> {
  _$CalendarStateCopyWithImpl(this._value, this._then);

  final CalendarState<T> _value;
  // ignore: unused_field
  final $Res Function(CalendarState<T>) _then;
}
...
/// @nodoc
class _$IdleCopyWithImpl<T, $Res> extends _$CalendarStateCopyWithImpl<T, $Res>
...
abstract class Idle<T> implements CalendarState<T> {
...
class _$LoadingCopyWithImpl<T, $Res>
    extends _$CalendarStateCopyWithImpl<T, $Res>
...
class _$Loading<T> implements Loading<T> {
  ...
  @override
  String toString() {
    return 'CalendarState<$T>.loading()';
  }
...
abstract class Loading<T> implements CalendarState<T> {
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$CalendarStateCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'CalendarState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements CalendarState<T> {
...
abstract class $DataCopyWith<T, $Res> {
  ...
  $Res call({Map<DateTime, List<Calendar>> data});
}

/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$CalendarStateCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  final Map<DateTime, List<Calendar>> data;

  @override
  String toString() {
    return 'CalendarState<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements CalendarState<T> {
  const factory Data({required Map<DateTime, List<Calendar>> data}) = _$Data<T>;

  Map<DateTime, List<Calendar>> get data => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
