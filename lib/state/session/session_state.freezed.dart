...
class _$SessionStateTearOff {
  ...
  Data<T> data<T>({List<TimetableEvent> data = const []}) {
    return Data<T>(
      data: data,
    );
  }
...
/// @nodoc
mixin _$SessionState<T> {
  @optionalTypeArgs
  TResult when<TResult extends Object?>({
    required TResult Function() idle,
    required TResult Function() loading,
    required TResult Function(String error) error,
    required TResult Function(List<TimetableEvent> data) data,
  }) =>
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<TimetableEvent> data)? data,
...
/// @nodoc
abstract class $SessionStateCopyWith<T, $Res> {
  factory $SessionStateCopyWith(
          SessionState<T> value, $Res Function(SessionState<T>) then) =
      _$SessionStateCopyWithImpl<T, $Res>;
}

/// @nodoc
class _$SessionStateCopyWithImpl<T, $Res>
    implements $SessionStateCopyWith<T, $Res> {
  _$SessionStateCopyWithImpl(this._value, this._then);

  final SessionState<T> _value;
  // ignore: unused_field
  final $Res Function(SessionState<T>) _then;
}
...
/// @nodoc
class _$IdleCopyWithImpl<T, $Res> extends _$SessionStateCopyWithImpl<T, $Res>
...
abstract class Idle<T> implements SessionState<T> {
...
/// @nodoc
class _$LoadingCopyWithImpl<T, $Res> extends _$SessionStateCopyWithImpl<T, $Res>
...
abstract class Loading<T> implements SessionState<T> {
...
/// @nodoc
class _$ErrorCopyWithImpl<T, $Res> extends _$SessionStateCopyWithImpl<T, $Res>
...
class _$Error<T> implements Error<T> {
  ...
  @override
  String toString() {
    return 'SessionState<$T>.error(error: $error)';
  }
...
abstract class Error<T> implements SessionState<T> {
...
abstract class $DataCopyWith<T, $Res> {
  ...
  $Res call({List<TimetableEvent> data});
}

/// @nodoc
class _$DataCopyWithImpl<T, $Res> extends _$SessionStateCopyWithImpl<T, $Res>
...
class _$Data<T> implements Data<T> {
  ...
  @override
  final List<TimetableEvent> data;

  @override
  String toString() {
    return 'SessionState<$T>.data(data: $data)';
  }
...
abstract class Data<T> implements SessionState<T> {
  const factory Data({List<TimetableEvent> data}) = _$Data<T>;

  List<TimetableEvent> get data => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
